		...
		*/
		function DeleteThisShift( shiftid, EmployeeID, StartTime, EndTime, TheDate)
		{
			...
			$.post('http://localhost/Capstone/index.php/DeleteAShift/DeleteTheShift', inputarr, function(data)
			{	
				...
				$.post('http://localhost/Capstone/index.php/CreateAShift/reloadTheScheduleArraybyGivenDate', inputDate, function(data)
				{	
